...
image::diagrams/curvature-top.svg[Aperture Curvature Top View,600,align="center"]
...
The posterior clearance depth SHALL be no less than *4.00 mm* measured axially from the rim mid-plane toward the posterior face of the rim.
