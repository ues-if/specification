...
* Listing of declared compliant products in the public compatibility registry;
...
* Listing in the official compatibility registry as a member company.
...
. Self-certify conformance by running the published test suite and keeping records;
...
|Published by the Association — keyed by brand and model name; no numeric manufacturer ID
|===
...
The Association's role is to maintain the specification and test suite, hold the trademark registration, publish the compatibility registry, and act on credible reports of misuse of the mark.
...
Run the conformance test suite defined in the specification against a representative production sample.
